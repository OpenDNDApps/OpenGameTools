...
namespace OGT.Editor
{
    public abstract class PropertyDrawerBase : PropertyDrawer
    {
        ...
        {
            float indentLength = OGTEditorGUI.GetIndentLength(rect);
            ...
            OGTEditorGUI.HelpBox(helpBoxRect, message, MessageType.Warning, context: property.serializedObject.targetObject);
